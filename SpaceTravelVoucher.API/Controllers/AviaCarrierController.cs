...
namespace SpaceTravelVoucher.API.Controllers
{
    ...
    [ApiController]
    public class AviaCarrierController : ControllerBase
    {
        private DataRepository<AviaCarrier, string> _repository;

        public AviaCarrierController()
        {
            _repository = new DataRepository<AviaCarrier, string>();
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Insert(AviaCarrier model)
        {
