...
namespace SpaceTravelVoucher.API.Controllers
{
    ...
    {
        private DataRepository<RailwayStation, string> _repository;

        public RailwayStationController()
        {
            _repository = new DataRepository<RailwayStation, string>();
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Insert(RailwayStation model)
        {
