...
namespace SpaceTravelVoucher.API.Controllers
{
    ...
    [ApiController]
    public class RailCarrierController : ControllerBase
    {
        private DataRepository<RailCarrier, string> _repository;

        public RailCarrierController()
        {
            _repository = new DataRepository<RailCarrier, string>();
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Insert(RailCarrier model)
        {
